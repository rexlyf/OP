...
try:
    ...
    print('[!] Error: some requirements are not installed')
    print('Type \'pip install -r requirements.txt\' to install all required packages')
    exit()

colors=['\033[1;31m','\033[1;32m','\033[1;33m','\033[1;34m','\033[1;35m','\033[1;36m']
W='\033[0m'
# The Credit For This Code Goes To Mr Beast Hacker All Other Contributors Listed At https://github.com/TheSpeedX/TBomb
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To namanhacker23@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By Mr Beast Hacker !!                ")
        print("==================================================================")
        try:
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tBoomB Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
